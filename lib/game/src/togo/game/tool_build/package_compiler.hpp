#line 2 "togo/game/tool_build/package_compiler.hpp"
/**
...
@defgroup tool_build_package_compiler PackageCompiler
@ingroup tool_build
@details
*/
...
#include <togo/game/tool_build/package_compiler.gen_interface>
