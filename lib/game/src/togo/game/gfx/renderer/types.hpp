#line 2 "togo/game/gfx/renderer/types.hpp"
/**
...
struct Renderer {
	...
	gfx::FramebufferID _active_framebuffer_id;
	...
	gfx::ResourceArray<gfx::Framebuffer, TOGO_GFX_NUM_FRAMEBUFFERS> _framebuffers;
