#line 2 "togo/core/math/vector/4x3.hpp"
/**
@copyright MIT license; see @ref index or the accompanying LICENSE file.

@file
@brief 4-by-3 matrix interface.
...
/** @cond INTERNAL */
template<class T>
struct TMat4x3<T>::operations {
	using type = typename TMat4x3<T>::type;
	...
	static TMat2x3<T> multiply(type_cref m, TMat2x4<T> const& n) {
		return TMat2x3<T>{
	...
	static TMat3x3<T> multiply(type_cref m, TMat3x4<T> const& n) {
		return TMat3x3<T>{
			m.data[0].x * n.data[0].x + m.data[1].x * n.data[0].y + m.data[2].x * n.data[0].z + m.data[3].x * n.data[0].w,
			m.data[0].y * n.data[0].x + m.data[1].y * n.data[0].y + m.data[2].y * n.data[0].z + m.data[3].y * n.data[0].w,
			m.data[0].z * n.data[0].x + m.data[1].z * n.data[0].y + m.data[2].z * n.data[0].z + m.data[3].z * n.data[0].w,
	...
	static TMat4x3<T> multiply(type_cref m, TMat4x4<T> const& n) {
		return TMat4x3<T>{
			m.data[0].x * n.data[0].x + m.data[1].x * n.data[0].y + m.data[2].x * n.data[0].z + m.data[3].x * n.data[0].w,
			m.data[0].y * n.data[0].x + m.data[1].y * n.data[0].y + m.data[2].y * n.data[0].z + m.data[3].y * n.data[0].w,
			m.data[0].z * n.data[0].x + m.data[1].z * n.data[0].y + m.data[2].z * n.data[0].z + m.data[3].z * n.data[0].w,
...
/** @name Comparison operators */ /// @{
	...
	template<class T>
	inline bool operator==(TMat4x3<T> const& m, TMat4x3<T> const& n) {
		return
			m.data[0] == n.data[0] &&
			m.data[1] == n.data[1] &&
			m.data[2] == n.data[2] &&
...
/** @name Arithmetic assignment operators */ /// @{
	...
	inline TMat4x3<T>& operator+=(TMat4x3<T>& m, U const& s) {
		m.data[0] += T(s);
		m.data[1] += T(s);
		m.data[2] += T(s);
		m.data[3] += T(s);
	...
	/// Add matrix.
	template<class T, class U>
	inline TMat4x3<T>& operator+=(TMat4x3<T>& m, TMat4x3<U> const& n) {
		m.data[0] += n.data[0];
		m.data[1] += n.data[1];
		m.data[2] += n.data[2];
		m.data[3] += n.data[3];
...
/** @name Increment and decrement operators */ /// @{
	/// Prefix increment.
	template<class T>
	inline TMat4x3<T>& operator++(TMat4x3<T>& m) {
		++m.data[0];
		++m.data[1];
		++m.data[2];
		++m.data[3];
	...
	template<class T>
	inline TMat4x3<T> operator++(TMat4x3<T>& m, signed) {
		TMat4x3<T> c{m};
		++m;
		return c;
	}
